  ...
  <body>
    ...
    <main role="main">
        ...
        <div class="col-md-12 mt-5 mb-3 text-right">
            <a href="/get_type_docs/create" class="btn btn-primary">Nuevo tipo de documento</a>
        </div>
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('edit_type_docs',$item["id"]) }}" class="btn btn-warning">Editar</a>
                            {!! Form::open(['route'=>['delete_type_docs',$item["id"],'METHOD'=>'POST']]) !!}
